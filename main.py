...
from src.brasa.transformer import BrasaTransformer
from src.brasa.interpreter import BrasaInterpreter
...
def run_brasa():
  ...
  grammar_path=Path(__file__).parent/'src'/'brasa'/'grammar.lark'
